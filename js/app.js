...
let thumbnails = document.querySelectorAll(".slider-thumbnail .slider-item");
...
function showSlider() {
   ...
   let thumbnailActiveOld = document.querySelector(".slider-thumbnail .slider-item.active");
